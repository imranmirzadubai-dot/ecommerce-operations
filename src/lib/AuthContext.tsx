...
const DIAGNOSTIC_AUTH = typeof window !== 'undefined' && (() => { const params = new URLSearchParams(window.location.search); return params.get('t227010') === '1' || params.get('t227011') === '1' || params.get('t227012') === '1' })()
