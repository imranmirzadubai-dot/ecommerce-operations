...
-- P11-T176: authoritative append-only financial adjustment command.
-- Financial corrections are recorded as new rows; existing adjustment rows are never mutated.
