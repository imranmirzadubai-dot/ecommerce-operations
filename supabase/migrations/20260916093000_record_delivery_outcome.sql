-- P10-T148: authoritative delivery outcome command.
-- Baseline lifecycle boundary: only In Transit parcels may receive an outcome here.
-- T149+ extends the command for NDR follow-up transitions.
...
begin
  ...
  if v_state<>'In Transit' then
    raise exception using errcode='P0001', message='Only In Transit parcels can receive a delivery outcome';
  end if;
