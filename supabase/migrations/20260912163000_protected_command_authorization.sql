...
-- P4-T084: make command-level authorization explicit for every authenticated
-- operational role. Cancellation is intentionally available to all three
-- approved roles; later tasks test the role matrix independently.
...
-- Parcel cancellation follows the same authenticated operational-role boundary.
