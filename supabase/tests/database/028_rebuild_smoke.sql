...
-- repository migrations and seed, runs `supabase db reset`, then executes all
-- pgTAP tests. These assertions confirm the rebuilt schema is present.
