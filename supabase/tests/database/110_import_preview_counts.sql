...
select function_source_like('public', 'preview_import_customer_changes', ARRAY['uuid','text'], 'set search_path = pg_catalog, public', 'preview command uses fixed search_path');
